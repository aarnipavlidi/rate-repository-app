...
// Alustetaan "ReposityListReviews" komponentti, joka suorittaa {...} sisällä
// olevat asiat aina, kun kyseiseen komponenttiin tehdään viittaus. Komponentti
// saa käyttöönsä myös "review" muuttujan arvon parametrina, joka tulee "FlatList"
// komponentin kautta eli "RepositoryListByID" komponentista. Kyseiselle komponentille
// annettu "propsin" arvo => "renderItem", jolle annettu parametrin arvoksi "item"
// eli "item" on yhtä kuin => "review" muuttujan arvo.
const ReposityListReviews = ({ review }) => {
...
// Viedään (export) alla oleva komponentti (ReposityListReviews) sovelluksen käytettäväksi, jotta esim. "App.js" tiedosto pystyy suorittamaan kyseiset funktiot.
export default ReposityListReviews;
